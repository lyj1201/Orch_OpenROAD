...
int Abc_NtkResubstitute2( Abc_Ntk_t * pNtk, Vec_Int_t **pGain, int nCutMax, int nStepsMax, int nLevelsOdc, int fUpdateLevel, int fVerbose, int fVeryVerbose )
{
    extern int           Dec_GraphUpdateNetwork( Abc_Obj_t * pRoot, Dec_Graph_t * pGraph, int fUpdateLevel, int nGain );
    ProgressBar * pProgress;
    Abc_ManRes_t * pManRes;
...
pManRes->timeRes += Abc_Clock() - clk;
        ...
        Vec_IntPush((*pGain), pManRes->nLastGain);
