...
if {$::env(ABC_AREA)} {
  puts "Using ABC orchstration area script."
  set abc_script $::env(SCRIPTS_DIR)/abc_orch.script
} else {
...
if {[info exist ::env(ABC_CLOCK_PERIOD_IN_PS)]} {
  ...
  abc -exe /mnt/raid10/yingjie/abc_Orchestration/SynOrchestration_rl/abc \
